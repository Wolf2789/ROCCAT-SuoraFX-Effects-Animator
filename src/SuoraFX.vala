...
namespace SuoraFXEffectsAnimator {
	public class SuoraFX {
		...
		public SuoraFX() {
			...
			public Packet[] rain = {
				new Packet({ 0x08, 0x01, 0x03, 0x0A, 0x00, 0x08, 0x01, 0xE0 }),
				new Packet({ 0x08, 0x02, 0x0A, 0x0A, 0x32, 0x08, 0x04, 0xA3 })
			};
			
			public Packet[] custom = {
				new Packet({ 0x08, 0x01, 0x33, 0x0A, 0x00, 0x08, 0x01, 0xB0 }),
				new Packet({ 0x12, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0xE5 }),
				new Packet({ 0x08, 0x02, 0x33, 0x0A, 0x32, 0x08, 0x00, 0x7E })
			};
			
			public Packet[] custom_data = {
				new Packet({0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
